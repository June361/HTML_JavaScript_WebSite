...
if ($result->num_rows > 0) 
{
	...
	{
	$k=$k+1;
        echo "<option value=".$k.">".$row["Name"] ."</option>";
...
echo "<form>";
echo "Select a Type:<br/>";
echo "<select name='Type' onchange='showtype(this.value)'>";
...
if ($result->num_rows > 0) 
{
	...
	{
	$k=$k+1;
        echo "<option value=".$k.">".$row["Type"] ."</option>";
...
echo "<form>";
echo "Select a Brand:<br/>";
echo "<select name='Brand' onchange='showtype(this.value)'>";
...
if ($result->num_rows > 0) 
{
	...
	{
	$k=$k+1;
        echo "<option value=".$k.">".$row["Brand"] ."</option>";
